...
public class DocumentController {
    ...
    public ResponseEntity<byte[]> downloadResumePdf(
        ...
        String pdfPath = pdfGeneratorService.generateResumePdf(tailored);
        byte[] pdfBytes = pdfGeneratorService.readPdfBytes(pdfPath);
    ...
    public ResponseEntity<byte[]> downloadCoverLetterPdf(
        ...
        String pdfPath = pdfGeneratorService.generateCoverLetterPdf(coverLetter);
        byte[] pdfBytes = pdfGeneratorService.readPdfBytes(pdfPath);
